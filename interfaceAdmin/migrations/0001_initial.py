# Generated by Django 4.2.7 on 2023-12-17 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_pago', models.CharField(choices=[('P', 'Pendiente'), ('S', 'Exitoso'), ('F', 'Fallido')], db_column='ESTADO_PAGO', default='P', max_length=1)),
            ],
            options={
                'db_table': 'estadopago',
                'managed': True,
